...
<html lang="en">
	<head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-5654483-1"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'UA-5654483-1');
        </script>
                    ...
                    <div class="container">
                        <div id="dining" class="row" style="display: block;">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 room marginb50">
                                ...
                                <img class="img-responsive marco" src="https://royalreservations.com/fb_pages/img/ancora-punta-cana.jpg" alt="Ancora Punta Cana Private Residence Yacht Club">

                                <div class="marcoInferior hotelRooms">

                                    <strong>Ancora Punta Cana Private Residence Yacht Club</strong>

                                    <div class="accommodation_description">

                                        <p>Ancora Punta Cana Private Residence Yacht Club, in the beautiful Punta Cana of the Dominican Republic, is a luxurious village on the waters of the exclusive Cap Cana Marina. This luxury resort boasts upscale accommodations with world-class services and amenities. Couples and families will delight in its spacious and beautiful suites.</p>

                                    </div>

                                    <form action="https://bookings.ihotelier.com/bookings.jsp" method="GET" target="_blank">
                                        <input name="hotelid" type="hidden" value="85285">
                                        <button type="submit" class="btn btn-danger">BOOK NOW!</button>
                                    </form>
                          ...
                          <!--  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 room marginb50">
                                ...
                                <img class="img-responsive marco" src="https://royalreservations.com/fb_pages/img/alsol-del-mar.jpg" alt="junior suite in Cancun Resort">

                                <div class="marcoInferior hotelRooms">

                                    <strong>AlSol Del Mar Cap Cana Resort</strong>

                                    <div class="accommodation_description">

                                        <p>Nestled in the amazing Punta Cana in the Dominican Republic, AlSol Del Mar will provide you with a luxury vacation experience along its private relaxing beach offering stunning views from its beautiful and spacious suites.</p>

                                    </div>

                                    <form action="https://bookings.ihotelier.com/bookings.jsp" method="GET" target="_blank">

                                        <input name="hotelid" type="hidden" value="86117">
