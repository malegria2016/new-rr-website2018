                    ...
                    <div class="container">
                        ...
                        <div class="row" style="display: block;">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center">
                                <img class="img-responsive marco-c" src="https://royalreservations.com/img/medium/<?php echo $offers_store[0]['identifier'] ?>-offer.jpg" alt="#">
                                ...
                                <div id="dos" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center">

                                    <img class="img-responsive marco-c" src="https://royalreservations.com/img/medium/<?php echo $offers_store[1]['identifier'] ?>-offer.jpg" alt="#">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center">
                                    <img class="img-responsive marco-c" src="https://royalreservations.com/img/medium/<?php echo $offers_store[2]['identifier'] ?>-offer.jpg" alt="#">
