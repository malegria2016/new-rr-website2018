<?php
    ...
    $bd=Db::getInstance();
    $sql='SELECT name,identifier,ihotelier_id,area,ihotelier_theme, location FROM resorts where status="1"';
				...
				<form class="booking" action="https://bookings.ihotelier.com/bookings.jsp" method="GET" target="_blank" onsubmit="return validateBooking();">  
				  ...
				  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 bookesp"> 
				   ...
				   <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 bookesp"> 
				   	...
				   	<img src="https://royalreservations.com/fb_pages/img/facebook-01.jpg" width="100%" class="marco">
		</div>
