...
return [
    ...
    'slug' => 'cyber-monday-playa-del-carmen',
    'thumbnail' => asset('img/deals/cyber-monday-playa-del-carmen.jpg'),
    ...
    'title_seo' => 'Playa del Carmen Cyber Monday | Royal Reservations',
    'alt_seo' => 'Playa del Carmen Vacation Special Offer',
	'metadescription' => 'Hurry, and take advantage of this Cyber Monday , only available for a few days! BOOK NOW AND GET A SPECIAL 49% OFF',
    ...
    'description'=>'
        <p class="text-justify" style="line-height: 2; font-weight: 300; font-size: .9rem;">
            We have launched Cyber Monday hot deal to travel to Playa del Carmen with Royal Reservations! Do not wait any longer and book now! Take advantage of this countdown offer valid for a few days. Get a 49% discount on your reservation and travel anytime this year or the next one, with the best All Inclusive Plan in one of the best beach destinations in the world in the heart of the Caribbean Sea in Mexico. Enjoy exclusive amenities and impeccable facilities in The Royal Haciendas in Playa del Carmen.
        </p>
        <p>This Offer is Valid Until: December 1st 2018. Travel Between November 26th  2018 to July 15th 2019</p>
