...
return [
    ...
    'slug' => 'buen-fin-cancun',
    'thumbnail' => asset('img/deals/buen-fin-cancun.jpg'),
    'title' => 'Cancún: Buen Fin',
    ...
    'title_seo' => 'Oferta de Buen Fin Cancún | Royal Reservations',
    'alt_seo' => 'Oferta de Vacaciones de Buen Fin a Cancún',
    ...
    'main_points' => [
        ...
        2=>'Wi-Fi de alta velocidad gratis',
    ...
    'description'=>'
        <p class="text-justify" style="line-height: 2; font-weight: 300; font-size: .9rem;">
            ¡Ha llegado el fin de semana del año que todos esperabamos para unas vacaciones en Cancún! Aprovecha esta venta relámpago de corta duración para reservar hoy mismo y recibir un descuento de hasta 49% en tu reservación, para viajar en cualquier época de este año o del siguiente, con los mejores planes Todo Incluido o Sólo Hospedaje. Elige alguno de nuestros 4 resorts en Cancún con impecables amenidades e instalaciones y la suite de tu preferencia para disfrutar unos días con tu familia, pareja o amigos.
        </p>
