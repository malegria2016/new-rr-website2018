			...
			<div class="w-100">
				<div class="container booking-interno-container">
					...
					<div class="contenedor-tabs">
                      ...
                      <select class="form-control combo" id="hotel" name="hotel">
...
function changeResort(resort){ //oculto casillas de edades, cambio etiquetas de edad del form principal de landing oferta
  ...
  function validaForm(){
    var resultado = true;
    var hotel_seleccionado = document.booking_engine_form_rh.hotel.selectedIndex;
    var hotel = document.booking_engine_form_rh.hotel.value;
    var airport = document.booking_engine_form_rh.airport.selectedIndex;
    var msg="";

    if(hotel_seleccionado<=0){
